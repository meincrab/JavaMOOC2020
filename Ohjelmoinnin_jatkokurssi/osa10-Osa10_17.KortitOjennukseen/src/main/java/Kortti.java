...
public class Kortti implements Comparable<Kortti> {
    ...
    @Override
    public int compareTo(Kortti toinenKortti) {
        return this.arvo == toinenKortti.getArvo()
                ? this.maa.ordinal() - toinenKortti.getMaa().ordinal()
                : this.arvo - toinenKortti.getArvo();
    }
