...
public class Paivays {
    ...
    public boolean equals(Object object) {
        ...
        Paivays verrattavaObjekti = (Paivays) object;
        if (verrattavaObjekti.paiva == this.paiva
                && verrattavaObjekti.kuukausi == this.kuukausi
                && verrattavaObjekti.vuosi == this.vuosi) {
            return true;
        }
        return false;
    }
